...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { end_date: @term.end_date, name: @term.name, start_date: @term.start_date } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { end_date: @term.end_date, name: @term.name, start_date: @term.start_date } }
