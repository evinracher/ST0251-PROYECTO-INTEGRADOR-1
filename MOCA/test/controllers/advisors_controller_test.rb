...
class AdvisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advisor" do
    assert_difference('Advisor.count') do
      post advisors_url, params: { advisor: { student_id: @advisor.student_id, term_id: @advisor.term_id } }
    end
  ...
  test "should update advisor" do
    patch advisor_url(@advisor), params: { advisor: { student_id: @advisor.student_id, term_id: @advisor.term_id } }
